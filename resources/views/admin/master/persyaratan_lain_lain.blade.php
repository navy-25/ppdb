...
@section('persyaratan_pendaftaran_lain_lain')
active
@endsection
...
<script>
    $('#data-table').DataTable({
        ...
        paging: true,
        order:[[0,'ASC']],
        ajax: "{{ route('getDataPersyaratan',['category'=>6])}}",
        columns: [
    ...
    function data_modal(data,url){
        ...
        $.get("/getPersyaratanAll?id_category=6", function(response){
...
<div class="row mb-3">
    <div class="col-6">
        <h6 class="card-title">Perbarui persyaratan lain lain</h6>
    </div>
    <div class="col-6">
        <button type="button"
            data-toggle="modal"
            data-target="#modalAdd"
            title="Tambah persyaratan lain lain"
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form class="modal-add" method="POST" action="{{ route('store_persyaratan_pendaftaran',['category'=>6]) }}">
                @csrf
                <div class="modal-header">
                    <h5>Tambah persyaratan lain lain</h5>
