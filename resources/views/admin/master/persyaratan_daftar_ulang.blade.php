...
@section('title')
Persyaratan Pendaftaran Daftar Ulang
@endsection

@section('persyaratan_pendaftaran_daftar_ulang')
active
@endsection
...
<script>
    $('#data-table').DataTable({
        ...
        paging: true,
        order:[[0,'ASC']],
        ajax: "{{ route('getDataPersyaratan',['category'=>5])}}",
        columns: [
    ...
    function data_modal(data,url){
        ...
        $.get("/getPersyaratanAll?id_category=5", function(response){
...
<div class="row mb-3">
    <div class="col-6">
        <h6 class="card-title">Perbarui persyaratan pendaftaran khusus jalur daftar ulang</h6>
    </div>
    <div class="col-6">
        <button type="button"
            data-toggle="modal"
            data-target="#modalAdd"
            title="Tambah persyaratan daftar ulang"
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form class="modal-add" method="POST" action="{{ route('store_persyaratan_pendaftaran',['category'=>5]) }}">
                @csrf
                <div class="modal-header">
                    <h5>Tambah persyaratan daftar ulang</h5>
